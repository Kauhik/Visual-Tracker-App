...
final class CloudKitSyncCoordinator {
    ...
    private enum SubscriptionID {
        ...
        static let expertiseCheckProgress = "vt_sub_expertiseCheckProgress"
    }
    ...
    private let subscriptionMap: [String: String] = [
        ...
        SubscriptionID.expertiseCheckProgress: RecordType.expertiseCheckProgress
    ]
    ...
    private func ensureSubscriptionsIfPossible() async {
        ...
        if await createQuerySubscriptionIfPossible(
            subscriptionID: SubscriptionID.expertiseCheckProgress,
            recordType: RecordType.expertiseCheckProgress,
            predicate: predicate
        ) { successCount += 1 } else { failureCount += 1 }
