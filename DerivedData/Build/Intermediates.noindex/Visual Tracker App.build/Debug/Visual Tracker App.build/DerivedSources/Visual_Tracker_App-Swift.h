...
#ifndef VISUAL_TRACKER_APP_SWIFT_H
#define VISUAL_TRACKER_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Visual_Tracker_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSData;
@class NSString;
SWIFT_CLASS("_TtC18Visual_Tracker_App11AppDelegate")
